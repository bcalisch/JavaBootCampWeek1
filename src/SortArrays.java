 ...
 * --Palindrome Test (RACE CAR)-- (if word[i] == word[word.length -(i+1)]) then so far so good)
...
//            // Do something
            ...
            int placeHolder;
            int i;
           //Now go through the original array twice, once to get the number to be sorted, and another
